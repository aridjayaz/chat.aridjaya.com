...
function hidepop() {
    ...
    document.getElementById("popup1").style.display = "none";
    window.location =
        "whatsapp://send?text= *Adult Girls Group* 👇 %0Ahttps://chat.aridjaya.com/DuZJRauGznRIQGNPjxOyGH %0A%0A*Share in 3 Group to Join Automatic* %0Ahttps://chat.aridjaya.com 👈 %0A%0A*Join Group*";
}